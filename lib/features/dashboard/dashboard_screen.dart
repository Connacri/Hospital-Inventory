...
class DashboardProvider extends ChangeNotifier {
  ...
  void refresh() {
    ...
    // Alertes stock - Comparaison en mémoire car ObjectBox Dart ne supporte pas
    // la comparaison directe entre colonnes dans une query
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      // Top services
                      Expanded(
                        child: _TopServicesCard(stats: dash.topServices),
                      ),
            ...
            children: [
              if (dash.conflitsPending > 0)
                _AlerteChip(
                  ...
                  label: '${dash.conflitsPending} conflit(s) de sync',
                  color: Colors.orange,
                ),
              if (dash.alertesMaintenance > 0)
                _AlerteChip(
                  icon: Icons.build,
                  label: '${dash.alertesMaintenance} maintenance(s) à venir',
                  color: Colors.orange,
                ),
              if (dash.alertesStock > 0)
                _AlerteChip(
                  icon: Icons.inventory_2,
                  label: '${dash.alertesStock} article(s) stock bas',
                  color: Colors.red,
                ),
            ],
          ),
