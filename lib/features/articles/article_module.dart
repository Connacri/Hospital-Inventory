      ...
      child: ConstrainedBox(
        ...
        child: Column(children: [
          ...
          Expanded(child: SingleChildScrollView(padding: const EdgeInsets.all(24), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            _row('Provenance', (article.madeIn ?? 'N/A').toTitleCase()),
            ...
            Text(article.description?.isNotEmpty == true ? article.description!.toTitleCase() : 'Aucune description fournie.', style: const TextStyle(color: _MedPalette.subtle, fontSize: 14)),
            const SizedBox(height: 24),
